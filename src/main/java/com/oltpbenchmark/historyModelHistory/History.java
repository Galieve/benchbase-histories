...
public class History {
    ...
    public History(History history) {
        ...
        this.wro = DataStructureUtilHistory.deepclone(history.wro);
        this.translator = history.translator;
        this.wroTransactions = DataStructureUtilHistory.deepclone(history.wroTransactions);
        this.soTransactions = DataStructureUtilHistory.deepclone(history.soTransactions);
        this.variablePerTable = DataStructureUtilHistory.deepcloneSet(history.variablePerTable);
        this.writePerVariable = DataStructureUtilHistory.deepcloneSet(history.writePerVariable);
        this.wroReadTransactions = DataStructureUtilHistory.deepclone(history.wroReadTransactions);
        this.wroPerTransaction = DataStructureUtilHistory.deepclone(history.wroPerTransaction);
    }

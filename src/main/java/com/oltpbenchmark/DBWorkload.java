...
public class DBWorkload {
    ...
    protected static void writeHistograms(Results r) {
    ...
    protected static String writeJSONHistograms(Results r) {
     ...
     * @throws Exception
     */
    protected static void writeOutputs(Results r, List<TransactionType> activeTXTypes, CommandLine argsLine, XMLConfiguration xmlConfig) throws Exception {
    ...
    protected static void runCreator(BenchmarkModule bench) throws SQLException, IOException {
    ...
    private static Results runWorkload(List<BenchmarkModule> benchList, int intervalMonitor) throws IOException {
        ...
        System.out.print("Finished results");
        return r;
    }
     ...
     * @return
     */
    protected static boolean isBooleanOptionSet(CommandLine argsLine, String key) {

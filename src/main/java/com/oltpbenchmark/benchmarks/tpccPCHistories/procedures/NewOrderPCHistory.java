...
package com.oltpbenchmark.benchmarks.tpccPCHistories.procedures;
...
import com.oltpbenchmark.benchmarks.tpccPCHistories.TPCCPCWorkerHistory;
...
public class NewOrderPCHistory extends TPCCProcedureNDHistory {

    private static final Logger LOG = LoggerFactory.getLogger(NewOrderPCHistory.class);
    ...
    public void run(Connection conn, Random gen, int terminalWarehouseID, int numWarehouses, int terminalDistrictLowerID, int terminalDistrictUpperID, long startTime, TPCCPCWorkerHistory w, ArrayList<Event> events, int id, int soID) throws SQLException {

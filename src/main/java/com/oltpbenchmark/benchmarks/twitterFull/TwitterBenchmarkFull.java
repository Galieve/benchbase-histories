...
package com.oltpbenchmark.benchmarks.twitterFull;
...
import com.oltpbenchmark.benchmarks.twitterFull.procedures.GetFollowersFull;
import com.oltpbenchmark.benchmarks.twitterFull.util.TraceTransactionGeneratorHistory;
import com.oltpbenchmark.benchmarks.twitterFull.util.TwitterOperationHistory;
...
public class TwitterBenchmarkFull extends BenchmarkModuleHistory {

    private final TwitterConfigurationHistory twitterConf;

    public TwitterBenchmarkFull(WorkloadConfiguration workConf) {
        super(workConf);
    ...
    protected Package getProcedurePackageImpl() {
        return GetFollowersFull.class.getPackage();
    }

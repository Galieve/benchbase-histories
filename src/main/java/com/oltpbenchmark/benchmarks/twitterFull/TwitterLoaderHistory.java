...
import com.oltpbenchmark.benchmarks.twitterFull.pojo.Follow;
import com.oltpbenchmark.benchmarks.twitterFull.pojo.Follower;
import com.oltpbenchmark.benchmarks.twitterFull.pojo.Tweet;
import com.oltpbenchmark.benchmarks.twitterFull.pojo.User;
import com.oltpbenchmark.benchmarks.twitterFull.util.TweetHistogramHistory;
...
public class TwitterLoaderHistory extends Loader<TwitterBenchmarkFull> {
    ...
    public TwitterLoaderHistory(TwitterBenchmarkFull benchmark, int so) {
        super(benchmark);

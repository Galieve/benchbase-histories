...
public final class TPCCConfigHistory {
    ...
    public final static int configItemCount = 500; // tpc-c std = 100,000
    public final static int configDistPerWhse = 3; // tpc-c std = 10
    public final static int configCustPerDist = 50; // tpc-c std = 3,000

    public final static int configMaxDistinctCust = Math.min(1000, configCustPerDist); // tpc-c std = 3,000

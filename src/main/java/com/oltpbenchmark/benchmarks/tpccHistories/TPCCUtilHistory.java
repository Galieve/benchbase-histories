...
import static com.oltpbenchmark.benchmarks.tpccHistories.TPCCConfigHistory.*;
...
public class TPCCUtilHistory {
    ...
    public static String getNonUniformRandomLastNameForRun(Random r) {
        return getLastName(nonUniformRandom(255, C_LAST_RUN_C, 0, configMaxDistinctCust - 1, r));
    }

    public static String getNonUniformRandomLastNameForLoad(Random r) {
        return getLastName(nonUniformRandom(255, C_LAST_LOAD_C, 0, configMaxDistinctCust - 1, r));
    }

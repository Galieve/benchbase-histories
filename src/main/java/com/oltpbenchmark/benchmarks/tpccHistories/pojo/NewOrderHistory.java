...
public class NewOrderHistory extends NewOrder  implements PojoHistory {

    public String no_writeID;
    ...
    public String toString() {
        ...
        spl.add(spl.size() - 2,"*       no_writeID = " + no_writeID);
        return String.join("\n", spl);
    }
    ...
    public List<Pair<String, String>> getPKsList() {
        return List.of(
            new Pair<>("INT", "NO_W_ID"),
            new Pair<>("INT", "NO_D_ID"),
            new Pair<>("INT", "NO_O_ID")
        );
    }
    ...
    public Set<String> getTableNames() {
        if(table == null){
            table = new HashSet<>(Collections.singleton("NewOrder"));
        }
        return table;
    }
}

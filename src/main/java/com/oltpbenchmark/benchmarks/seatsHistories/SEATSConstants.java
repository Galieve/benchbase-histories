...
public abstract class SEATSConstants {
     ...
     * If you change this then you must also change FindOpenSeatsHistory
     */
    ...
    /**
     * Probability that a customer will invoke DeleteReservationHistory using the string
     * version of their Customer Id (0% - 100%)
     */
    public static final int PROB_DELETE_WITH_CUSTOMER_ID_STR = 20;

    /**
     * Probability that a customer will invoke UpdateCustomerHistory using the string
     * version of their Customer Id (0% - 100%)
     */
    ...
    /**
     * Probability that UpdateCustomerHistory should update FrequentFlyer records
     */
    public static final int PROB_UPDATE_FREQUENT_FLYER = 25;

    /**
     * Probability that a new Reservation will be added to the DeleteReservationHistory queue
     */
    public static final int PROB_DELETE_RESERVATION = 50;

    /**
     * Probability that a new Reservation will be added to the UpdateReservationHistory queue
     */
    public static final int PROB_UPDATE_RESERVATION = 50;

    /**
     * Probability that a deleted Reservation will be requeued for another NewReservationHistory call
     */
    public static final int PROB_REQUEUE_DELETED_RESERVATION = 90;

    /**
     * Probability that FindFlightsHistory will use the distance search
     */
    public static final int PROB_FIND_FLIGHTS_NEARBY_AIRPORT = 25;

    /**
     * Probability that FindFlightsHistory will use two random airports as its input
     */

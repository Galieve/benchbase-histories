...
import com.oltpbenchmark.benchmarks.tpccNDHistories.procedures.TPCCProcedureNDHistory;
...
public class TPCCWorkerNDHistory extends WorkerHistory<TPCCBenchmarkNDHistory> {

    private static final Logger LOG = LoggerFactory.getLogger(TPCCWorkerNDHistory.class);
    ...
    public TPCCWorkerNDHistory(TPCCBenchmarkNDHistory benchmarkModule, int id,

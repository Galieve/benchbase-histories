...
public class PaymentNDHistory extends TPCCProcedureNDHistory {

    private static final Logger LOG = LoggerFactory.getLogger(PaymentNDHistory.class);
    ...
    public void run(Connection conn, Random gen, int w_id, int numWarehouses, int terminalDistrictLowerID, int terminalDistrictUpperID, long startTime, TPCCWorkerNDHistory worker, ArrayList<Event> events, int id, int soID) throws SQLException {

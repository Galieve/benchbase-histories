...
public class PaymentHistory extends TPCCProcedureHistory {

    private static final Logger LOG = LoggerFactory.getLogger(PaymentHistory.class);
    ...
    public void run(Connection conn, Random gen, int w_id, int numWarehouses, int terminalDistrictLowerID, int terminalDistrictUpperID, long startTime, TPCCWorkerHistory worker, ArrayList<Event> events, int id, int soID) throws SQLException {

...
public class OrderStatusHistory extends TPCCProcedureHistory {

    private static final Logger LOG = LoggerFactory.getLogger(OrderStatusHistory.class);
        ...
        if (LOG.isTraceEnabled()) {
            ...
            if (o.o_id == -1) {
                ...
                if (orderLines.size() != 0) {
                    sb.append(" [Supply_W - Item_ID - Qty - Amount - DeliveryHistory-Date]\n");

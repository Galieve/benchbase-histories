...
import com.oltpbenchmark.benchmarksHistory.tpccHistories.procedures.TPCCProcedureHistory;
...
public class TPCCWorkerHistory extends WorkerHistory<TPCCBenchmarkHistory> {

    private static final Logger LOG = LoggerFactory.getLogger(TPCCWorkerHistory.class);
    ...
    public TPCCWorkerHistory(TPCCBenchmarkHistory benchmarkModule, int id,
    ...
    protected TransactionStatus executeWorkHistory(Connection conn, TransactionType nextTransaction, ArrayList<Event> events, int id, int soID) throws UserAbortException, SQLException {
        try {
            ...
            TPCCProcedureHistory proc =
                    (TPCCProcedureHistory) this.getProcedure(nextTransaction.getProcedureClass());

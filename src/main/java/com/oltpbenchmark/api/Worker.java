...
public abstract class Worker<T extends BenchmarkModule> implements Runnable {
    ...
    protected WorkloadState workloadState;
    ...
    protected void updateHistogram(TransactionStatus status, TransactionType transactionType){
        switch (status) {
    ...
    protected boolean isRetryable(SQLException ex) {
    ...
    /**
     * Invoke a single transaction for the given TransactionTypeHistory
     *
     * @param conn    TODO
     * @param txnType TODO
     * @return TODO

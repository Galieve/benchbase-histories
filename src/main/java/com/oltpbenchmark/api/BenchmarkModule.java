...
public abstract class BenchmarkModule {
    protected static final Logger LOG = LoggerFactory.getLogger(BenchmarkModule.class);
     ...
     */
    public Loader<? extends BenchmarkModule> loadDatabase() throws SQLException, InterruptedException {
    ...
    /**
     * Initialize a TransactionTypeHistory handle for the get procedure name and id
    ...
    public TransactionType initTransactionType(String procName, int id, long preExecutionWait, long postExecutionWait) {
    ...
    /**
     * Return a mapping from TransactionTypesHistory to Procedure invocations
     *
     * @return
     */

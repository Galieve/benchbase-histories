...
executeBenchmark () {
    ...
    for i in $(seq 1 $ENDSESSIONS); do
        ...
        xmlstarlet ed -L -u "/parameters/works/work/time" -v "$i" "experiments/${optionsFolderName}/${name}/${isolationCase}/${name}-${i}_config.xml"
...
executeTwitter() {
    ...
    executeBenchmark "twitterHistories" "Session-Scalability" "SER" options[@] isolationMap[@]
    ...
    executeBenchmark "twitterHistories" "Session-Scalability" "SI+RC" options[@] isolationMap[@]
    ...
    executeBenchmark "twitterHistories" "Session-Scalability" "SER+RC" options[@] isolationMap[@]
}
...
executeTPCC() {
    ...
    executeBenchmark "tpccHistories" "Session-Scalability" "RC" options[@] isolationMap[@]
...
executeTPCCPC() {
    ...
    executeBenchmark "tpccPCHistories" "Session-Scalability" "SER" options[@] isolationMap[@]
    ...
    executeBenchmark "tpccPCHistories" "Session-Scalability" "SI" options[@] isolationMap[@]
    ...
    executeBenchmark "tpccPCHistories" "Session-Scalability" "RC" options[@] isolationMap[@]
    ...
    executeBenchmark "tpccPCHistories" "Session-Scalability" "SI+RC" options[@] isolationMap[@]
